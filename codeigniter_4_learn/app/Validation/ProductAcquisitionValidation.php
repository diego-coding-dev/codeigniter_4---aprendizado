...
class ProductAcquisitionValidation extends BaseValidation {

    private $rules = [
        'batch' => [
            'label' => 'batch',
            'rules' => 'required|max_length[50]|is_unique[batch_product_acquisition.batch]'
        ],
        'total' => [
            'label' => 'quantity',
    ...
    private $rulesMessageErrors = [
        'batch' => [
            ...
            'is_unique' => 'Este lote já está registrado.'
        ],
        'total' => [
