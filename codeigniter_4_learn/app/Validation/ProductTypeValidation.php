...
class ProductTypeValidation extends BaseValidation {
    ...
    private $rulesMessageErrors = [
        'description' => [
            'required' => 'A tipo do produto é obrigatório.'
        ]
    ];
     ...
     * @return array|null mensagens de erro de validação
     */
    public function getRulesErrors(): array|null {
