...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-black-800">Adicionar funcionário</h1>
</div>
...
<div class="row">
    <div class="col-md-12 col-lg-6">
        ...
        <?php echo form_open('privado/funcionarios/adicionar', ['class' => 'user', 'autocomplete' => 'off']); ?>
        ...
        <?php echo form_open("privado/funcionarios/adicionar/telefone", ['class' => 'user', 'autocomplete' => 'off']); ?>
    ...
    <div class="col-md-12 col-lg-6">
        ...
        <?php echo $this->include('Restrict/Employee/complement/listTelephone'); ?>
