                        ...
                        <?php foreach ($telephoneList as $telephone) : ?>
                            <tr>
                                ...
                                <td class="text-center" style="width: 110px;">
                                    <a href="<?php echo site_url('privado/funcionarios/adicionar/telefone/excluir/' . $telephone['id_session']) ?>" class="text-danger" style="text-decoration: none;"><i class="fas fa-fw fa-trash fa-lg"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
