...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-black-800">Lista de produtos</h1>
</div>

<a href="<?php echo site_url('privado/produtos/adicionar') ?>" class="btn btn-primary btn-sm">Adicionar</a>

<!-- Search -->
<div class="row d-flex justify-content-center mt-2">
    <div class="col-sm-6">

        <?php echo form_open('privado/produtos/procurar', ['class' => 'user', 'autocomplete' => 'off']); ?>
...
<div class="row d-flex justify-content-center">
    <div class="col-sm-12">
                    ...
                    <?php foreach ($productsList as $product) : ?>
                        ...
                        <tr>
                            ...
                            <td style="width: 110px;">
                                ...
                                <a href="<?php echo site_url('privado/produtos/excluir/' . $product->id) ?>" style="text-decoration: none;"><i class="fas fa-fw fa-trash fa-lg text-danger"></i></a>
                            </td>
                        </tr>
        ...
        <?php else : ?>
            ...
            <h4 class="text-center mt-3">Não há produtos registrados</h4>
