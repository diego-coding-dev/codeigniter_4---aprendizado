...
<div class="row d-flex justify-content-center mt-3">
    <div class="col-sm-6">
        <?php echo form_open('privado/produtos/adicionar/departamento/procurar', ['class' => 'user', 'autocomplete' => 'off']); ?>
            ...
            <table class="table table-striped mt-3">
                ...
                <tbody>
                    <?php foreach ($departmentList as $department) : ?>
                        <tr>
                            <td>
                                <?php echo esc($department->description); ?>
                            </td>
                            <td style="width: 110px;">
                                <a href="<?php echo site_url('privado/produtos/adicionar/departamento/selecionar/') . $department->id; ?>" style="text-decoration: none;" type="button" class="btn btn-success btn-inline btn-sm"><i class="fas fa-fw fa-plus fa-lg text-black"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
