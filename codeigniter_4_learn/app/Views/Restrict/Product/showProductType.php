...
<div class="row d-flex justify-content-center mt-3">
    <div class="col-sm-6">
        <?php echo form_open('privado/produtos/adicionar/tipo_produto/procurar', ['class' => 'user', 'autocomplete' => 'off']); ?>
    ...
    <div class="col-sm-12">
        <?php if (count($productsTypeList) > 0) : ?>
            <table class="table table-striped mt-3">
                ...
                <tbody>
                    <?php foreach ($productsTypeList as $productsType) : ?>
                        <tr>
                            <td>
                                <?php echo esc($productsType->description); ?>
                            </td>
                            <td style="width: 110px;">
                                <a href="<?php echo site_url('privado/produtos/adicionar/tipo_produto/selecionar/') . $productsType->id; ?>" style="text-decoration: none;" type="button" class="btn btn-success btn-inline btn-sm"><i class="fas fa-fw fa-plus fa-lg text-black"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
