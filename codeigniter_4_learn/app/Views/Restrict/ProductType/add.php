...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-black-800">Adicionar categoria de produto</h1>
</div>
...
<div class="row">
    <div class="col-md-12 col-lg-6">
        ...
        <?php echo form_open('privado/tipo_de_produtos/registrar', ['class' => 'user', 'autocomplete' => 'off']); ?>

        <div class="form-group">
            <label>Categoria de produto</label>
            <input type="text" class="form-control  <?php echo session('error_validation.description') ? 'border border-danger' : ''; ?>" id="description" name="description" placeholder="Categoria">
