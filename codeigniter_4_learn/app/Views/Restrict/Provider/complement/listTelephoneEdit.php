                    ...
                    <tbody>
                        <?php foreach ($telephoneList as $telephone) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo esc($telephone->description); ?>
                                </td>
                                <td class="text-center" style="width: 110px;">
                                    <a href="<?php echo site_url('privado/fornecedores/editar/excluir_telefone/' . $telephone->id) ?>" class="text-danger" style="text-decoration: none;"><i class="fas fa-fw fa-trash fa-lg"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
