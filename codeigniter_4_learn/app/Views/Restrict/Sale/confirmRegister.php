...
<div class="row d-flex justify-content-center">
    <div class="col-xl-3 col-md-6 mt-5">
        ...
        <a href="<?php echo site_url('privado/vendas/adicionar/finalizar') ?>" class="btn btn-success btn-lg">Confirmar</a>

        <a href="<?php echo site_url('privado/vendas/adicionar/resumo') ?>" class="btn btn-danger btn-lg ml-4">Não</a>
    </div>
</div>
