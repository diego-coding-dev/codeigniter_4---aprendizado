...
<div class="row d-flex justify-content-center">
    <div class="col-sm-12">
        ...
        <?php if ($totalInCart > 0) : ?>
            <a href="<?php echo site_url('privado/vendas/adicionar/dados_adicionais') ?>" class="btn btn-success btn-sm">Dados adicionais</a>
        <?php endif; ?>
                ...
                <tbody>
                    ...
                    <?php foreach ($productsList as $product) : ?>
                        ...
                        <tr>
                            ...
                            <td style="width: 110px;"><a href="<?php echo site_url('privado/vendas/adicionar/produtos/selecionar/' . $product->product_id); ?>" style="text-decoration: none;" type="button" class="btn btn-success btn-inline btn-sm"><i class="fas fa-fw fa-plus fa-sm"></i></a></td>
                        </tr>
